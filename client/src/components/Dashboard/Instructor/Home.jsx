...
const Card = ({ title, caption, img, redirect }) => {
    ...
    return (
        <div className='bg-gray-700 relative w-[40rem] h-[25rem] rounded-md overflow-hidden shadow-2xl cursor-pointer' onClick={() => handleNavigation(navigate, redirect)} onMouseEnter={showDetails} onMouseLeave={hideDetails}>
