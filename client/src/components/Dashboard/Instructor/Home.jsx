...
const Card = ({ title, caption, img }) => {
    ...
    return (
        <div className='bg-gray-700 relative w-[40rem] h-[25rem] rounded-md overflow-hidden shadow-2xl cursor-pointer' onMouseEnter={showDetails} onMouseLeave={hideDetails}>
    ...
    return (
        <div className='fixed left-[5.5rem] w-full h-screen bg-gray-800'>
            ...
            <div className='flex flex-row gap-4 w-full mx-10'>
                <Card title={"Question Banks"} caption={"Create and manage question banks"} img={QuestionBankImg}/>
                <Card title={"Exams"} caption={"Create and manage exams"} img={ExamImg}/>
            </div>
        </div>
    )
}
